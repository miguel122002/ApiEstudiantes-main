...
namespace ApiEstudiante.Controllers
{
    ...
    public class Tipos_sangreController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Tipos_sangre>>> GetTipo_sangre()
        {
        ...
        {
            if (id != tipos_sangre.id_tipos_sangre)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<Tipos_sangre>> PostTipos_sangre(Tipos_sangre tipos_sangre)
        {
          if (_context.Tipos_sangre == null)
          {
              return Problem("Entity set 'Conexiones.Tipo_sangre'  is null.");
          }
            _context.Tipos_sangre.Add(tipos_sangre);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetTipos_sangre", new { id = tipos_sangre.id_tipos_sangre }, tipos_sangre);
        }
        ...
        {
            return (_context.Tipos_sangre?.Any(e => e.id_tipos_sangre == id)).GetValueOrDefault();
        }
    }
}
